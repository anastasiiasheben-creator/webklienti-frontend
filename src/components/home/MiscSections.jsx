  ...
  return (
    <div style={{ background: C.bg, padding: '96px 40px', borderBottom: `1px solid ${C.border}`, borderLeft: '6px solid #16A34A' }}>
      <div style={{ maxWidth: 780, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%', maxWidth: '100%', margin: '0 auto', textAlign: 'left' }}>
          {t.riskPoints.map(p => {
            const text = p.replace(/^✓\s*/, '');
            return (
              <div key={p} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, fontSize: 16, color: C.text, lineHeight: 1.5 }}>
