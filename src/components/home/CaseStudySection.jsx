...
const translations = {
  en: {
    ...
    afterTitle: 'Live website: montwell.sk',
    beforePoints: ['They only have an Instagram profile', 'No website', 'Hard to find on Google'],
    afterPoints: ['Professional website', 'Project gallery', 'Clients can now find them via Google search'],
    result: '🎯 Website launched within 5 days · professional presentation that builds trust with customers · ready to generate leads',
    subImageText: 'Real result of client work — no templates',
  ...
  cz: {
    ...
    afterTitle: 'Reálný web: montwell.sk',
    beforePoints: ['Mají pouze Instagram profil', 'Žádný web', 'Těžko dohledatelní na Google'],
    afterPoints: ['Profesionální web', 'Galerie realizací', 'Klienti je dnes najdou přes Google vyhledávání'],
    result: '🎯 Web spuštěný do 5 dnů · profesionální prezentace, která buduje důvěru u zákazníků · připraveno na získávání poptávek',
  ...
  sk: {
    ...
    afterTitle: 'Reálny web: montwell.sk',
    beforePoints: ['Majú len Instagram profil', 'Žiadny web', 'Ťažko nájditeľní na Google'],
    afterPoints: ['Profesionálny web', 'Galéria realizácií', 'Klienti ich dnes nájdu cez Google vyhľadávanie'],
    result: '🎯 Web spustený do 5 dní · profesionálna prezentácia, ktorá buduje dôveru u zákazníkov · pripravené na získavanie dopytov',
