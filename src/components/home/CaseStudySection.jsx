...
const translations = {
  en: {
    ...
    afterPoints: ['Professional website', 'Project gallery', 'Clients can now find them via Google search', 'Contact form built for new inquiries'],
    result: '🎯 Montwell.sk launched in 3 days · a sales website that builds trust and generates inquiries',
  ...
  cz: {
    ...
    afterPoints: ['Profesionální web', 'Galerie realizací', 'Klienti je dnes najdou přes Google vyhledávání', 'Kontaktní formulář pro nové poptávky'],
    result: '🎯 Montwell.sk spuštěn do 3 dnů · prodejní web, který buduje důvěru a generuje poptávky',
  ...
  sk: {
    ...
    afterPoints: ['Profesionálny web', 'Galéria realizácií', 'Klienti ich dnes nájdu cez Google vyhľadávanie', 'Kontaktný formulár pre nové dopyty'],
    result: '🎯 Montwell.sk spustený do 3 dní · predajný web, ktorý buduje dôveru a generuje kontakty',
