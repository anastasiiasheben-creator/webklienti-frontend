...
const posts = [
  { slug: 'preco-kazda-mala-firma-potrebuje-web', title: 'Prečo dnes každá malá firma potrebuje web?', excerpt: '87 % zákazníkov hľadá firmy na Google. Zistite, prečo bez webu strácate zákazníkov v prospech konkurencie a ako lacno a rýchlo získať vlastný web.', date: '12. februára 2025', readTime: '8 min čítania' },
  { slug: 'ai-na-webstranke-konkurencna-vyhoda', title: 'AI na vašej webstránke: konkurenčná výhoda, ktorú už používajú úspešné firmy', excerpt: 'AI chatboty a inteligentné vyhľadávanie na webe zvyšujú počet dopytov a šetria čas. Zistite, ako AI funguje na webe malej firmy a čo naozaj prináša.', date: '19. mája 2026', readTime: '8 min čítania' },
  ...
  { slug: 'google-search-console-a-google-analytics', title: 'Google Search Console a Google Analytics: Prečo sú nevyhnutné pre moderný web', excerpt: 'Zistite, prečo sú Google Search Console a Google Analytics nevyhnutné pre úspešný web. Naučte sa sledovať návštevnosť, SEO výsledky a správanie zákazníkov.', date: '28. júna 2025', readTime: '8 min čítania' },
  { slug: 'kolko-stoji-webstranka-na-slovensku', title: 'Koľko stojí webstránka na Slovensku v roku 2026?', excerpt: 'Ceny webstránok na Slovensku sa pohybujú od 200 € po desiatky tisíc. Zistite, za čo skutočne platíte a akú cenu má zmysel zaplatiť za váš web.', date: '30. mája 2026', readTime: '9 min čítania' },
  { slug: 'preco-web-neprinas-zakaznikov', title: 'Prečo vám web neprináša zákazníkov (a ako to zmeniť)', excerpt: 'Váš web vyzerá dobre, ale telefón nezvoní? Zistite 5 najčastejších dôvodov, prečo web neprináša dopyty, a konkrétne kroky, ako to zmeniť.', date: '29. apríla 2025', readTime: '8 min čítania' },
  { slug: 'preco-vas-eshop-nepredava', title: 'Prečo váš e-shop nepredáva?', excerpt: 'Ľudia na e-shop prídu, ale nekúpia? Zistite 6 najčastejších dôvodov, prečo e-shop nepredáva, a konkrétne kroky, ako zvýšiť počet objednávok.', date: '11. mája 2026', readTime: '8 min čítania' },
