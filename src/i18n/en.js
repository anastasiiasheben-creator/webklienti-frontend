const en = {
  ...
  "problemClose": "The Result: Your competition keeps growing while you lose dozens of high-value leads every month.",
  ...
  "solutionSteps": [
    {
      "num": "01",
      "title": "Risk-Free Inquiry",
      "desc": "Select your goals, tell us briefly about your business, and submit a 60-second form."
    },
    {
      "num": "02",
      "title": "Concept in 24 Hours",
      "desc": "We build and deliver an initial visual and strategic homepage draft completely free of charge."
    },
    {
      "num": "03",
      "title": "Refining Details",
      "desc": "If you love the direction, we polish the copy, structure, and features to align with your vision."
    },
    {
      "num": "04",
  ...
  "cards": [
    {
      ...
      "features": [
        ...
        "100% responsive optimization for smartphones and tablets",
        "Direct click-to-call, email, and interactive map setups",
        "WhatsApp and Messenger integration for instant customer chat",
    ...
    },
    {
      ...
      "features": [
        ...
        "Up to 5 fully custom-designed pages (Services, About Us, etc.)",
        "Clean project gallery and organized client testimonials section",
        "Modern blog/article layout with an easy self-managed system",
        "In-depth keyword research and advanced custom SEO framework",
        "Google Analytics integration for precise conversion tracking",
        "Complete delivery and handover within 7 business days"
      ],
      "featured": true,
      "dark": false
    },
    {
      ...
      "features": [
        ...
        "Fully scalable e-commerce engine hosting up to 500 products",
        "Secure payment gateways integration (Stripe, Cards, Apple Pay)",
        "Automated PDF invoicing and real-time inventory management",
        "Intuitive dashboard for tracking orders and customer data",
        "Facebook Shop and Instagram Shopping catalog sync",
        "Complete delivery and handover within 14 business days"
      ],
      "featured": false,
      "dark": true
    }
  ...
  "fields": [
    ...
    {
      "key": "phone",
      "label": "Phone Number (for quick clarifications)",
      "type": "tel",
  ...
  "faqItems": [
    ...
    },
    {
      ...
      "a": "We take care of that. Following a quick brief about your target market, we write high-converting marketing copy for you. If you don't possess custom business photography, we source licensed, high-tier premium stock images that match your brand identity perfectly."
    },
    {
      "q": "Who owns the finished website after deployment?",
      "a": "You do, entirely. Unlike closed platforms that lock you into monthly rental traps, we build independent code and hand over full administrative ownership. You have complete freedom over your asset."
    },
    {
  ...
  "trustStrip": [
    ...
    "Full strategic coverage for EU, UK, and global markets",
    "Built with a single metric in mind: Converting traffic into high-intent inbound inquiries"
  ],
  "consentLabel": "I agree to the processing of personal data for the purpose of preparing a non-binding proposal in accordance with the",
  "consentLink": "Privacy Policy",
  "consentError": "You must check the consent box to submit an inquiry successfully."
};
