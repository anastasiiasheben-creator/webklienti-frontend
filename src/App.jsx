...
const T = {
  sk: {
    ...
    guaranteeText: 'Prvý návrh webu dostanete do 24 hodín zdarma. Ak sa vám nebude páčiť, neplatíte nič. Žiadne záväzky, žiadne skryté poplatky.',
    guaranteeBadges: ['✓ Návrh do 24 hodín', '✓ Platíte až po schválení', '✓ Web je po odovzdaní váš'],
...
Platné od: 1.1.2025`,
  ...
  cz: {
    ...
    guaranteeTitle: 'Bez rizika',
    guaranteeText: 'První návrh webu dostanete do 24 hodin zdarma. Pokud se vám nebude líbit, neplatíte nic. Žádné závazky, žádné skryté poplatky.',
    guaranteeBadges: ['✓ Návrh do 24 hodin', '✓ Platíte až po schválení', '✓ Web je po předání váš'],
    formLabel: 'Objednávka',
...
Platné od: 1.1.2025`,
  ...
  en: {
    ...
    guaranteeText: "You get your first website draft within 24 hours, for free. If you don't like it, you pay nothing. No commitments, no hidden fees.",
    guaranteeBadges: ['✓ Draft in 24 hours', '✓ Pay only after approval', '✓ Website is yours after delivery'],
    formLabel: 'Order',
